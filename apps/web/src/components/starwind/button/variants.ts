...
export const button = tv({
  ...
  variants: {
    variant: {
      ...
      outline:
        "dark:border-input focus-visible:ring-outline/50 bg-card dark:bg-input/30 focus-visible:border-outline hover:bg-muted dark:hover:bg-input/50 hover:text-foreground border shadow-xs",
